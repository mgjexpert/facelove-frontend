...
import { LockKeyhole, Globe2, Heart } from "lucide-react";
  ...
  return (
    <article className="post-card">
      <div className="post-author">
        <div className="post-avatar"><Image src="/images/ana-fictional-cover.jpg" alt="" fill sizes="42px" /></div>
        <div><strong>Ana Oliveira</strong><span>@anaoliveira · {new Date(post.publishedAt + "T12:00:00").toLocaleDateString("pt-PT", { day: "numeric", month: "short" })}</span></div>
